	...
	describe('test', function () {
	    ...
	    it('should connect react class 3', function (done) {
	        ...
	        var A = (_dec25 = (0, _.Reducer)('test'), (_class22 = function (_Store15) {
	            ...
	            return A;
	        }(_2.default), (_applyDecoratedDescriptor(_class22.prototype, 'test', [_dec25], Object.getOwnPropertyDescriptor(_class22.prototype, 'test'), _class22.prototype)), _class22));
	    ...
	    it('should connect to default state ', function (done) {
	        ...
	        var A = (_dec33 = (0, _.Reducer)('test'), (_class30 = function (_Store19) {
	            ...
	            return A;
	        }(_2.default), (_applyDecoratedDescriptor(_class30.prototype, 'test', [_dec33], Object.getOwnPropertyDescriptor(_class30.prototype, 'test'), _class30.prototype)), _class30));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = exports.Inject = exports.Reducer = undefined;
	...
	var GET_STATE = Symbol();
	var GET_SOURCE = Symbol();
	
	var NOTIFY = Symbol();
	
	var getSource = function getSource(source, arg) {
	...
	var getState = function getState(state, stateArg, sourceArg) {
	    var source = getSource(state, sourceArg);
	    var s = {};
